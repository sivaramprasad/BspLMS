          ...
          <div className="absolute right-0 hidden h-full min-h-screen md:block lg:w-[49vw] 2xl:w-[44vw]">
            ...
            >
              <div className="relative flex h-full w-full">
                <div
                  style={{ backgroundImage: `url(https://backstagepass.co.in/instituteofgaming.png)`, backgroundSize: "contain",  backgroundPosition: "center",  backgroundRepeat: "no-repeat", width: "80%", margin: "0 auto" }}
