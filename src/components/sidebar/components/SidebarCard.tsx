const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#f43c45] via-[#ec1923] to-brand-500 pb-4">
      <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-gradient-to-b from-[#f43c45] to-brand-500 dark:!border-navy-800">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p style={{color: "#fff"}} className="text-lg font-bold text-white">#1 Gaming College in India</p>
        <p style={{color: "#fff"}} className="mt-1 px-4 text-center text-sm text-white">
        ...
        <a
         style={{color: "#fff"}}
          ...
          href="https://www.backstagepass.co.in/"
        >
          Upgrade to Career
        </a>
      </div>
